          ...
          <div className="relative z-10 px-8 py-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h1 className="text-4xl font-extrabold text-white tracking-tight">Pengumuman & Artikel</h1>
                  <p className="text-emerald-100 mt-2 text-lg">Kelola konten pengumuman untuk karyawan</p>
                </div>
              </div>
              <button
                onClick={() => openModal()}
                className="hidden lg:flex items-center gap-2 px-5 py-3 bg-white text-emerald-700 rounded-xl font-semibold hover:bg-emerald-50 transition-all shadow-lg"
              >
